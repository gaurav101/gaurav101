...
- **[LuminaJS](https://github.com/gaurav101/LuminaJS)** - A modular, chainable, lightweight, zero-dependency JavaScript utility library for browser-based image processing using the HTML5 Canvas API. Perfect for real-time image manipulation in the browser.
- **[numtowords](https://github.com/gaurav101/numtowords)** - Convert numbers to words in multiple languages and numeral systems — English, Indian, Hindi, German, French — with full TypeScript support. Handles complex conversions with ease.
- **[numtowords-website](https://github.com/gaurav101/numtowords-website)** - Interactive web interface for the numtowords library with real-time conversion demonstration
- **[Decision-tree-editor](https://github.com/gaurav101/Decision-tree-editor)** - Full-featured decision tree visualization editor built with TypeScript and React. Includes interactive node editing and tree traversal. [Demo](https://treeflow1.netlify.app/)
- **[d3-world-map](https://github.com/gaurav101/d3-world-map)** - Interactive world map visualization using D3.js with geospatial data rendering (TypeScript)


### 🚀 Backend & Java Development
- **[FluentMarkdown](https://github.com/gaurav101/FluentMarkdown)** - A lightweight, zero-boilerplate Java library that converts Markdown to styled HTML for any CSS framework — Tailwind, Bootstrap, Bulma, or your own custom classes — using a clean fluent API. Built on top of commonmark-java for robust Markdown parsing.
- **[observer-java](https://github.com/gaurav101/observer-java)** - Observer design pattern implementation in Java with practical examples and best practices
- **[chat-bot-backend](https://github.com/gaurav101/chat-bot-backend)** - Chat bot backend service built with Java, demonstrating RESTful API design and message processing


### 🦀 Rust Projects
- **[rust-apps](https://github.com/gaurav101/rust-apps)** - Collection of Rust applications exploring systems programming concepts
- **[simple-rust-calcuator](https://github.com/gaurav101/simple-rust-calcuator)** - Simple calculator application showcasing Rust's type safety and performance
- **[RustroverProjects](https://github.com/gaurav101/RustroverProjects)** - Collection of Rust projects using Rustover IDE

### 🌐 Web & API Development
- **[REST-API-ENGINE](https://github.com/gaurav101/REST-API-ENGINE)** - Production-ready REST API engine built in PHP with routing, middleware, and error handling
- **[php-apns](https://github.com/gaurav101/php-apns)** - PHP Apple Push Notification Service implementation for iOS push notifications
- **[single-file-comment-edior](https://github.com/gaurav101/single-file-comment-edior)** - Lightweight comment editor tool for inline code documentation
  
### 📖 Learning & Other Projects
- **[portfolio](https://github.com/gaurav101/portfolio)** - Personal portfolio project showcasing my work and skills
- **[gaurav101.github.io](https://github.com/gaurav101/gaurav101.github.io)** - GitHub Pages personal portfolio with recent updates (last updated: June 2026)
- **[clean-code-javascript-and-react](https://github.com/gaurav101/clean-code-javascript-and-react)** - Clean Code principles adapted for JavaScript and React development
...
- 🐙 [GitHub Profile](https://github.com/gaurav101)
